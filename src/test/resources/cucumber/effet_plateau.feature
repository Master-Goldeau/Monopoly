...
Fonctionnalité: Effet des cases du plateau sur le joueur
  ...
  Scénario: Un joueur lance les dés et arrive sur la case aller en prison
    Étant donné un joueur sur la case 19 avec 450 euros
  ...
  Plan du scénario: un joueur arrive sur une case de pioche, pioche une carte et son effet de déplacement est appliqué
  ...
  Plan du scénario: un joueur arrive sur une case de pioche, pioche une carte et son effet autre que déplacement est appliqué
    ...
    Exemples:
      | caseJoueur | valeurDes1 | valeurDes2 | caseArrivee | typeCarte            | cartePiochee            | argent | argentFinal |
      | 34         | 1          | 1          | 36          | CHANCE               | DIVIDENDE               | 648    | 698         |
      | 2          | 3          | 2          | 7           | CHANCE               | PRET_IMMOBILIER         | 94     | 244         |
      | 34         | 1          | 1          | 36          | CHANCE               | AMENDE_EXCES_VITESSE    | 648    | 663         |
      | 29         | 1          | 3          | 33          | CAISSE_DE_COMMUNAUTE | CAISSE_DE_VACANCES      | 1000   | 1100        |
      | 29         | 1          | 3          | 33          | CAISSE_DE_COMMUNAUTE | ASSURANCE_VIE           | 1000   | 1100        |
      | 29         | 1          | 3          | 33          | CAISSE_DE_COMMUNAUTE | FRAIS_SCOLARITE         | 1000   | 950         |
      | 29         | 1          | 3          | 33          | CAISSE_DE_COMMUNAUTE | REMBOURSEMENT_IMPOTS    | 1000   | 1020        |
      | 29         | 1          | 3          | 33          | CAISSE_DE_COMMUNAUTE | HOPITAL                 | 1000   | 900         |
      | 29         | 1          | 3          | 33          | CAISSE_DE_COMMUNAUTE | HONORAIRES_CONSULTATION | 1000   | 1025        |
      | 29         | 1          | 3          | 33          | CAISSE_DE_COMMUNAUTE | VENTE_STOCK             | 1000   | 1050        |
